...
def main():
    ground_truth_file = "./datasets/EHF_category_dataset/test_start_EHF_category_dataset.txt"
    prediction_file = "./predictions/start_ss_rubric_32_01/test_EHF_category_dataset.md"
